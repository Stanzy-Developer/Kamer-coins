...
/* import images */
import Image1 from "../img/feature-1-img.png";
      ...
      <div className="flex flex-col lg:flex-row ">
        ...
        >
          ...
          <p className=" text-gray mb-8">
            Get full statistic information about the behavior or buyers and
            sellers will help you to make the best decision.
          </p>
