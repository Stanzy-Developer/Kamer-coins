...
const CalcForm = () => {
  return (
    <div
      className="w-full bg-white max-w-[942px] mx-auto rounded-2xl txt-darkblue p-12"
      data-aos="fade-up"
      data-aos-offset="500"
    >
      {/* form */}
      ...
      {/* text */}
      <div className="mt-24">
        <div className="text-blue font-meduim mb-4">
          ESTIMATED 24 HOUR REVENUE:
        </div>
        <div className="text-[32px font-bold mb-3 text-black">
          0.055 130 59 ETH <span className="text-blue">($1275)</span>
        </div>
        <div className="text-gray-500 tracking-[1%]">
          Revenue will change base on mining difficulty and Ethereum price.
        </div>
      </div>
    </div>
  );
